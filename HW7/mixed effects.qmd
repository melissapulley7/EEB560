...
author: "Dr. Alejandro Molina-Moctezuma (if turning in a lab in this format, write your name here instead of mine!)"
format: html
editor: visual
---
...
Let's do the same, but now, both the intercept and the slope are random.
...
m4<- glmmTMB(Hg~size + (1|region), data=HgDat_df)
